...
export default class eztempmail$com extends Provider {
    domain = 'www.eztempmail.com';
    customLaravelCookie = 'ez_temp_mail_session';
    ...
    async getAddress(): Promise<string> {
        ...
        const req2 = await this.fetch(`https://${this.domain}/get_messages`, {
            method: 'POST',
    ...
    async getMail(): Promise<Mail[]> {
        ...
        const req = await this.fetch(`https://${this.domain}/get_messages`, {
            method: 'POST',
